...
| **Architectural discussions & standards** | `docs/adr/`: Architecture Decision Records documenting key trade-offs:<br>• [ADR-001](docs/adr/ADR-001-monorepo-workspace.md): Monorepo & Shared Types<br>• [ADR-002](docs/adr/ADR-002-relational-state-machine.md): Relational State Machine<br>• [ADR-003](docs/adr/ADR-003-dual-database-and-containerization.md): Dual SQLite & PostgreSQL Strategy |
